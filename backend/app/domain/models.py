...
class Chapter(Base):
    ...
    id = Column(String, primary_key=True, default=generate_uuid)
    world_id = Column(String, ForeignKey("world.id"), nullable=False)
...
class Level(Base):
    ...
    id = Column(String, primary_key=True, default=generate_uuid)
    chapter_id = Column(String, ForeignKey("chapter.id"), nullable=False)
    engine_id = Column(String, ForeignKey("game_engine.id"), nullable=False)
...
class Question(Base):
    ...
    id = Column(String, primary_key=True, default=generate_uuid)
    level_id = Column(String, ForeignKey("level.id"), nullable=False)
    prompt_text = Column(Text, nullable=False)
    prompt_audio = Column(String, nullable=True)
    category = Column(String, default="huruf") # huruf, angka, motorik, logika, bahasa, puzzle
...
class Progress(Base):
    ...
    id = Column(String, primary_key=True, default=generate_uuid)
    child_id = Column(String, ForeignKey("child.id"), nullable=False)
    level_id = Column(String, ForeignKey("level.id"), nullable=False)
